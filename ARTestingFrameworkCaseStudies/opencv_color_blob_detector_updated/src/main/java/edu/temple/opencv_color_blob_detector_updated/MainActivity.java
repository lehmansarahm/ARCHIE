package edu.temple.opencv_color_blob_detector_updated;
...
import edu.temple.gtc_core.tester_support.ConfigFile;
import edu.temple.gtc_core.tester_support.IGtcCallbackListener;

public class MainActivity extends Activity implements OnTouchListener, CvCameraViewListener2, IGtcCallbackListener {
    ...
    // --------------------------------------------------------------------------------------------
    //      GTC FRAMEWORK SPECIFIC LOGIC
    // --------------------------------------------------------------------------------------------

    private static final String PROC_NAME = "BlobDetector";
    private static final String CONFIG_FILE = "file:///android_asset/config.json";

    private static final String EVENT_NAME_TOUCH = "User Touch Event";
    private static final String EVENT_NAME_DETECT = "Detect Blobs";

    private static GtcController gtcController;

    private void initGtc() {
        if (gtcController == null)
            gtcController = new GtcController(this, this, android.os.Process.myPid(),
                    PROC_NAME, CONFIG_FILE);
    ...
    @Override
    public void onTestProfileReady(ConfigFile.TestingProfile currentProfile) {
    ...
    public String onClassificationClockStart(String eventLabel) {
        switch (eventLabel) {
            case EVENT_NAME_TOUCH:
                break;
            case EVENT_NAME_DETECT:
                break;
            default:
                break;
        }
