...
public class ModifiedSpeechActivity extends Activity {
    ...
    private static final String LOG_TAG = ModifiedSpeechActivity.class.getSimpleName();

    // Working variables.
    short[] recordingBuffer = new short[Constants.RECORDING_LENGTH];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // with an underscore.
        String actualFilename = Constants.LABEL_FILENAME.split("file:///android_asset/")[1];
        ...
        recognizeCommands =
                new RecognizeCommands(
                        labels,
                        Constants.AVERAGE_WINDOW_DURATION_MS,
                        Constants.DETECTION_THRESHOLD,
                        Constants.SUPPRESSION_MS,
                        Constants.MINIMUM_COUNT,
                        Constants.MINIMUM_TIME_BETWEEN_SAMPLES_MS);

        // Load the TensorFlow model.
        inferenceInterface = new TensorFlowInferenceInterface(getAssets(), Constants.MODEL_FILENAME);
    ...
    private void recognize() {
        ...
        short[] inputBuffer = new short[Constants.RECORDING_LENGTH];
        float[] floatInputBuffer = new float[Constants.RECORDING_LENGTH];
        float[] outputScores = new float[labels.size()];
        String[] outputScoresNames = new String[] {Constants.OUTPUT_SCORES_NAME};
        int[] sampleRateList = new int[] {Constants.SAMPLE_RATE};
        ...
        while (shouldContinueRecognition) {
            ...
            // Run the model.
            inferenceInterface.feed(Constants.SAMPLE_RATE_NAME, sampleRateList);
            inferenceInterface.feed(Constants.INPUT_DATA_NAME, floatInputBuffer,
                    Constants.RECORDING_LENGTH, 1);
            inferenceInterface.run(outputScoresNames);
            inferenceInterface.fetch(Constants.OUTPUT_SCORES_NAME, outputScores);
            ...
            try {
                ...
                Thread.sleep(Constants.MINIMUM_TIME_BETWEEN_SAMPLES_MS);
