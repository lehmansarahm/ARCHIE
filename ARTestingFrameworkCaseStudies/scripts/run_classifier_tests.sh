...
TRIAL_NAMES=('_tenClassifiers')

CONFIG_NAMES=('config_10classifiers.json')

#TRIAL_NAMES=('_oneClassifier' \
#    '_threeClassifiers' \
#    '_fiveClassifiers' \
#    '_sevenClassifiers' \
#    '_tenClassifiers')

#CONFIG_NAMES=('config_1classifier.json' \
#    'config_3classifiers.json' \
#    'config_5classifiers.json' \
#    'config_7classifiers.json' \
#    'config_10classifiers.json')
