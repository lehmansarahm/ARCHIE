...
import edu.temple.tf_tester.env.BorderedText;
import edu.temple.tf_tester.env.ImageUtils;
    ...
    */
    ...
    public void onPreviewSizeChosen(final Size size, final int rotation) {
        ...
        frameToCropTransform = ImageUtils.getTransformationMatrix(
                previewWidth, previewHeight, INPUT_SIZE, INPUT_SIZE,
    ...
    private void renderDebug(final Canvas canvas) {
        ...
        if (copy != null) {
            ...
            if (classifier != null) {
                ...
                for (String line : statLines) lines.add(line);
            }
