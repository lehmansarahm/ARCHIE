...
public class BaseTFImageClassifier {
     ...
     * @throws IOException
     */
    public static BaseTFImageClassifier create(AssetManager assetManager, String modelFilename, String labelFilename,
                                               int inputSize, int imageMean, float imageStd, String inputName, String outputName) {

        BaseTFImageClassifier c = new BaseTFImageClassifier();
        c.inputName = inputName;
        c.outputName = outputName;

        // Read the label names into memory.
        String actualFilename = labelFilename.split("file:///android_asset/")[1];
        Log.i(Constants.TAG, "Reading labels from: " + actualFilename);
        ...
        Log.i(Constants.TAG, "Read " + c.labels.size() + " labels, output layer size is " + numClasses);
