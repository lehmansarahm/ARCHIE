...
public class ServiceUtil {
    ...
    public static void sendMessageToService(Messenger destMessenger, Messenger sourceMessenger, int messageCode, Bundle data) {
        ...
        try {
            ...
            Log.e(Constants.TAG, "Cannot send message to destination messenger if it is null!  Have you started the GTC Annotator app???", ex);
        } catch (RemoteException ex) {
            Log.e(Constants.TAG, "Failed to send message to Messenger service.", ex);
        }
    }
    ...
    public static Notification createNotification(Context context, String contentTitle,
        ...
        Log.d(Constants.TAG, "Creating new service notification.");
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            if (defaultChannel == null) {
                Log.d(Constants.TAG, "Notification channel for GTC Services does not exist.  Creating new channel.");
            ...
            else Log.d(Constants.TAG, "Notification channel for GTC Services already exists.  Using existing channel.");
        }
